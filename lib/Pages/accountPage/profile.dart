...
import 'package:tutorchat/Pages/accountPage/response.dart';
            ...
            children: [
              Container(
                ...
                child: GestureDetector(
                  onTap: () async {
                    fetchData(widget.profileData.image);
                    // await getProfilePhotoFunc(widget.profileData.image);
                  },
                  //   child: Image.memory(constUserPhoto!)
                  // CachedNetworkImage(
                  //   imageUrl: constUserPhoto.,
